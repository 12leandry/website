    ...
    <main id="main">
        ...
        <div class="breadcrumbs d-flex align-items-center"
            ...
            <div class="container position-relative d-flex flex-column align-items-center" data-aos="fade">
                <br><br><br>
                <h2>Contact</h2>
                <h6 class="text-light">"L'expertise dont vous avez besoin, à portée de main. Contactez-nous et découvrez comment <br> nous pouvons
                    réaliser vos objectifs ensemble."</h6>
                    ...
                    <div class="col-lg-6">
                        ...
                        <form action="{{ route('send.contact.email') }}" method="post" role="form">
                            ...
                            <div class="row gy-4">
                                ...
                                <div class="text-center"><button type="submit" class="btn btn-danger">Send Message</button>
                                </div>
                            </div>
                        </form>
                    </div>
