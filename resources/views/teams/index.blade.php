                            ...
                            <tbody>
                                @foreach ($teams as $team)
                                    <tr>
                                        ...
                                        <td> {{ Illuminate\Support\Str::limit($team->facebook, 10, '...') }}</td>
                                        <td>{{ Illuminate\Support\Str::limit($team->twitter, 10, '...') }}</td>
                                        <td>{{ Illuminate\Support\Str::limit($team->linkedin, 10, '...') }}</td>
