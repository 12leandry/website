  ...
  <header id="header" class="header fixed-top d-flex align-items-center">
    <div class="container-fluid container-xl d-flex align-items-center justify-content-between">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          <li><a href="{{route('home')}}" class="{{ $activeLink == 'home' ? 'active' : ' ' }}">Home</a></li>
          <li><a href="{{route('About')}}" class="{{ $activeLink == 'About' ? 'active' : ' ' }}">About</a></li>
          <li><a href="{{route('Services')}}" class="{{ $activeLink == 'Services' ? 'active' : ' ' }}">Services</a></li>
